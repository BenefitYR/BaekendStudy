...
import demo.demo.common.status.ResultCode
...
class CustomExceptionHandler {
    ...
    @ExceptionHandler(demo.demo.common.exception.InvalidInputException::class)
    protected fun invalidInputException(ex: demo.demo.common.exception.InvalidInputException):
    ResponseEntity<BaseResponse<Map<String, String>>> {
